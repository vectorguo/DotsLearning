...
namespace BigCat.BigWorld
{
    ...
    public class BigWorldTerrainBatchRenderGroup : MonoBehaviour
    {
        ...
        public const uint sizeOfPerInstance = (sizeOfPackedMatrix + sizeof(int) - 1) / sizeof(int) * sizeof(int); //确保是sizeof(int)的整数倍
        ...
        public int AddBatchGroup(BigWorldTerrainBatchGroupConfig batchGroupConfig)
        {
            ...
            m_batchGroups.Add(new BigWorldTerrainBatchGroup(id, batchGroupConfig, m_brg));
            return id;
        }
    ...
    public class BigWorldTerrainBatchGroup
    {
        ...
        public BigWorldTerrainBatchGroup(int id, BigWorldTerrainBatchGroupConfig batchGroupConfig, BatchRendererGroup brg)
        {
            m_id = id;
